...
namespace AIM.Client.Entities.Models
{
	...
	public partial class User : ModelBase<User>, ITrackable
	{
		...
		[DataMember]
		public Nullable<decimal> socialSecurityNumber
		{ 
		...
		private Nullable<decimal> _socialSecurityNumber;

		[DataMember]
		public string socialSecurityNumberCoder
		{ 
			get { return _socialSecurityNumberCoder; }
			set
			{
				if (value == _socialSecurityNumberCoder) return;
				_socialSecurityNumberCoder = value;
				NotifyPropertyChanged(m => m.socialSecurityNumberCoder);
			}
		}
		private string _socialSecurityNumberCoder;
