...
namespace AIM.Web.Application.Controllers
{
    public class StoreController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="storeId,name,regionId,regionName,street,street2,city,state,zip")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="storeId,name,regionId,regionName,street,street2,city,state,zip")] Store store)
        {
            if (ModelState.IsValid)
            {
